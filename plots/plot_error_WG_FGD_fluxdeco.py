...
def plot_xsec_errs(subsets, dials, idials, pot, fit_paths_wagasci):
    ...
    for i in range(len(dials)):
        ...
        gr_temp2 = TGraph(len(pot), apot, rel_error_evolution(i, idials, pot, fit_paths_fgd_wagasci, xsectype))
        ...
        gr_temp3 = TGraph(len(pot), apot, rel_error_evolution(i, idials, pot, fit_paths_fgd_wagasci_fluxdeco, xsectype))
        #gr_temp3.SetTitle(dials[i])
    ...
    leg.AddEntry(line2, "WG+FGD", "l")
    leg.AddEntry(line3, "WG+FGD_fluxdeco", "l")
    leg.Draw()
    ...
    c1.SaveAs("plots/pot_studies/xsec/WAGASCI_FGD_fluxdeco/{}_migrad.png".format(subsets))
...
fit_paths_fgd_wagasci_fluxdeco = [
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/WAGASCI_FGD_fluxdeco/pot0.33.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/WAGASCI_FGD_fluxdeco/pot1.3.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/WAGASCI_FGD_fluxdeco/pot2.3.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/WAGASCI_FGD_fluxdeco/pot3.3.root",
]
