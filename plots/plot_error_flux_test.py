...
def plot_xsec_errs(subsets, dials, idials, pot, fit_paths_wagasci):
    ...
    for i in range(len(dials)):
        ...
        gr_temp3 = TGraph(len(pot), apot, rel_error_evolution(i, idials, pot, fit_paths_fgd_cutmatrix, xsectype))
        #gr_temp3.SetTitle(dials[i])
    ...
    leg.AddEntry(line3, "Caspar ND280 only", "l")
    leg.Draw()
    ...
    c1.SaveAs("plots/pot_studies/xsec/FGD_fluxtest/{}_migrad.png".format(subsets))
...
fit_paths_fgd_cutmatrix = [
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/FGD_cutmatrix/pot0.33.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/FGD_cutmatrix/pot1.3.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/FGD_cutmatrix/pot2.3.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc/FGD_cutmatrix/pot3.3.root",
]
