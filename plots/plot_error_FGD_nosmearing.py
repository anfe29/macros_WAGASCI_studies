...
def plot_xsec_errs(subsets, dials, idials, pot, fit_paths_fgd):
    ...
    for i in range(len(dials)):
        ...
        gr_temp3 = TGraph(len(pot), apot, rel_error_evolution(i, idials, pot, fit_paths_fgd_nosmearing, xsectype))
        #gr_temp3.SetTitle(dials[i])
    ...
    leg.AddEntry(line3, "FGD nosmear", "l")
    leg.Draw()
    ...
    c1.Update()     
    c1.SaveAs("plots/pot_studies/xsec/FGD_nosmearing/{}_hesse.png".format(subsets))
...
fit_paths_fgd_nosmearing = [
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc_rhc/FGD_nosmearing/pot0.33.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc_rhc/FGD_nosmearing/pot1.3.root",
    "studies_sampKenj/outputs/prelim_jointfit/pot_fhc_rhc/FGD_nosmearing/pot2.3.root",
    #"studies_sampKenj/outputs/prelim_jointfit/pot_fhc_rhc/FGD_nosmearing/pot7.3.root",
]
