...
# this method was developped by Jaafar bc he wanted to correlated the O p-shell params
# but we found that there are certain restrictions for these values and for correlations
# under a certain amount they might affect the likelihood in unintuitive ways
